...
class Like {
  ...
  // Events
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.like-box').on('click', e => this.ourClickDispatcher(e));
  }
...
class MyNotes {
  ...
  // Events
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#my-notes').on('click', '.delete-note', e => this.deleteNote(e));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#my-notes').on('click', '.edit-note', e => this.editNote(e));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#my-notes').on('click', '.update-note', e => this.updateNote(e));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.submit-note').on('click', e => this.createNote(e));
  }
      ...
      this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.campuses.length ? '<ul class="link-list min-list">' : '<p style="color:red;font-weight:bolder;">Currently disabled</p>'}
                            ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')}
                        ${results.campuses.length ? '</ul>' : ''}
                        <h2 class="search-overlay__section-title">Events</h2>
                        ${results.events.length ? '<ul class="link-list min-list">' : '<p style="color:red;font-weight:bolder;">Currently disabled</p>'}
